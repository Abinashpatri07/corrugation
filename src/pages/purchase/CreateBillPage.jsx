...
const CreateBillPage = () => {
  ...
  // Store all vendors fetched from backend
  const [vendors, setVendors] = useState([]);

  // Currently selected vendor
  const [selectedVendorId, setSelectedVendorId] = useState("");

  // Get the complete vendor object for the selected vendor
  const selectedVendor = vendors.find(
    (vendor) =>
      String(vendor.vendorId) === String(selectedVendorId)
  );

  // Loading state for vendor dropdown
  ...
  // Discount value entered by the user
  ...
  /*
 * Fetch vendors from backend when Create Bill page loads.
 */
  useEffect(() => {
  ...
  // Total quantity from all item rows
  const totalQuantity = rows.reduce(
    (total, row) => total + Number(row.quantity || 0),
    0
  );

  // Subtotal = Quantity × Rate for every row
    ...
    <main className="flex-1 flex flex-col overflow-hidden bg-[#f4f7f9] p-1.5 gap-1.5">
      ...
      <div className="flex-1 overflow-hidden flex flex-col gap-1.5">
        ...
        <div className="flex-1 overflow-y-auto flex flex-col gap-3 custom-scrollbar">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option
                        value=""
                        className="text-[#1a233a] bg-white"
                      >
                        {vendorsLoading
                          ? "Loading vendors..."
                          : "Select Vendor"}
                  ...
                  <div className="mt-3 w-[300px] border border-blue-200 rounded-lg p-4 bg-[#f8faff] shadow-sm">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        {/* Vendor contact/name */}
                        <h4 className="text-[14px] font-bold text-[#1a233a]">
                        ...
                        {/* Company */}
                        {selectedVendor.companyName && (
                          <p className="text-[13px] text-[#1a233a] mt-1">
                            {selectedVendor.companyName}
                          </p>
                        )}
                        ...
                        {selectedVendor.vendorCode && (
                          <p className="text-[13px] text-[#1a233a]">
                        ...
                        {/* Phone */}
                        {selectedVendor.primaryNumber && (
                          <p className="text-[13px] text-[#1a233a]">
                            Phone: {selectedVendor.primaryNumber}
                          </p>
                        )}
              ...
              <div key={row.id} className="grid gap-2 items-center py-2"
                ...
                <div className="flex items-center border border-gray-200 rounded-md shadow-sm overflow-hidden bg-white">
                  ...
                  <button
                    ...
                    className="px-2 py-2 hover:bg-gray-50 text-gray-400"
                  >
                    <Minus className="w-3.5 h-3.5" />
                  </button>
                  ...
                  <input
                    ...
                    className="flex-1 text-center text-[12px] py-2 focus:outline-none w-10 border-none"
                  />
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-md shadow-sm pl-7 pr-3 py-2 text-[12px] focus:outline-none focus:border-blue-500"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-md shadow-sm pl-7 pr-3 py-2 text-[12px] focus:outline-none bg-gray-50"
                    readOnly
                  />
                </div>
          ...
          {/* ── Bottom Section ──Both columns now have equal width */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 shrink-0 pb-4">
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex flex-col">
              ...
              <h3 className="text-[16px] font-bold text-[#1a233a] mb-6">
                Invoice Totals
              </h3>
              ...
              <div className="flex items-center gap-4 mb-6 text-[12px] font-bold text-gray-500">
                ...
                <label className="flex items-center gap-1.5 cursor-pointer text-[#d54a88]">
                  <input
                    type="radio"
                    name="tax_type"
                    className="w-3.5 h-3.5 accent-[#d54a88]"
                    defaultChecked
                  />
                  TCS
                </label>
              ...
              <div className="flex flex-col gap-5 flex-1">
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <label className="text-[12px] font-bold text-[#1a233a]">
                      Discount
                    </label>
                    ...
                    <div className="flex border border-gray-200 rounded shadow-sm overflow-hidden">
                      ...
                      <button
                        ...
                        className={`px-2 py-0.5 text-[11px] font-bold ${discountType === "percent"
                          ? "text-white bg-gradient-to-r from-[#d54a88] to-[#ff7a59]"
                      ...
                      <button
                        ...
                        className={`px-2 py-0.5 text-[11px] font-bold ${discountType === "amount"
                          ? "text-white bg-gradient-to-r from-[#d54a88] to-[#ff7a59]"
                          : "text-gray-500 bg-white"
                          }`}
                      >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      className="w-[70%] border border-gray-200 shadow-sm rounded-md px-3 py-2 text-[12px] focus:outline-none focus:border-blue-500"
                      placeholder="0"
                    />

                    {/* Calculated discount amount */}
                    <span className="text-[13px] font-bold text-[#1a233a]">
                ...
                <div>
                  ...
                  <label className="block text-[12px] font-bold text-[#1a233a] mb-2">
                    Tax
                  </label>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative w-[70%]">
                      ...
                      <select
                        ...
                        className="w-full border border-gray-200 rounded-md shadow-sm pl-3 pr-8 py-2 text-[12px] focus:outline-none focus:border-blue-500 appearance-none bg-white text-gray-700"
                      >
                      ...
                      <ChevronDown
                        className="absolute right-2 top-2.5 w-3.5 h-3.5 text-gray-400 pointer-events-none"
                      />
              ...
              <div className="mt-6 bg-[#f8f5ff] rounded-xl px-5 py-4 shadow-sm border border-[#eee8fc] flex justify-between items-center">
                ...
                <div>
                  ...
                  <div className="text-[15px] font-bold text-[#1a233a]">
                    Grand Total
                  </div>
